...
def login():
    ...
    return RedirectResponse(
        f"https://accounts.spotify.com/authorize?response_type=token&client_id={client_id}&scope={scope}&redirect_uri={redirect_uri}&state={state}"
    )
